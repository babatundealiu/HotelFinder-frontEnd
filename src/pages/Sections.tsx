...
const Sections:React.FC = () => {
  return (
    <div className='flex flex-col mm:ml-12 text-gray-800'>
        <h1 className='mm:ml-5 ms:ml-12 font-bold text-3xl sm:text-sm sm:mt-10 sm:text-gray-800 sm:ml-8 ml-16 mb-5 md:text-gray-800 lg:text-gray-800 lg:mt xl:text-gray-800 text-gray-800'>HOTELS IN SECTION</h1>
