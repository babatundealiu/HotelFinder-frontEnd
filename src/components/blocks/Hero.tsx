...
const Hero:React.FC = () => {
  return (
    ...
    <div className='flex lg:mt-20 flex-row justify-center mt-[200px] sm:mt-[128px] md:mt-[30px] xl:mt-[10px]'>
      <div className='flex justify-center gap-0 shadow-2xl sm:gap-1 lg:gap-0 md:gap-2 bg-white w-[89%] h-[130px] sm:h-[50px] sm:border sm:w-[314px] md:w-[95%] md:h-[110px] md: rounded-md border-2 border-blue-500 lg:w-[90%] sm:mt-2 xl:mt-28 mt-[120px]'>
